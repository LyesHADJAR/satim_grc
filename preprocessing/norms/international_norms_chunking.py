...
if __name__ == "__main__":
    pdf_path = "norms\\international_norms\\PCI-DSS-v4_0_1.pdf"
    output_json = "norms\\international_norms\\pci_dss_chunks.json"
    doc_title = "PCI-DSS v4.0.1"

    chunker = PCISectionChunker(document_title=doc_title)
